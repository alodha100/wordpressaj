...
mysql -u root -e "GRANT ALL PRIVILEGES ON wordpressdb.* TO 'root'@'localhost' IDENTIFIED BY 'Ajay@123'";
mysql -u root -pAjay@123 -e "FLUSH PRIVILEGES;"
mysql -u root -pAjay@123 -e "EXIT;"
